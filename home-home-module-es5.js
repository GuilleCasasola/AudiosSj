(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_audios_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../services/audios.service */
      "./src/app/services/audios.service.ts");

      var HomePage = /*#__PURE__*/function () {
        function HomePage(audiosService, route) {
        ...
        _createClass(HomePage, [{
          ...
          value: function ngOnInit() {
            ...
            this.audiosService.getAudios().subscribe(function (data) {
              ...
              _this.route.queryParams.subscribe(function (data) {
                if (data.audio) {
                  var audio = _this.audios.find(function (post, index) {
          ...
          value: function play(a) {
            ...
            this.pausar(a);
            setTimeout(function () {
              _this3.audioSrc = a.url;
              _this3.dataAudioPlaying = a;
          ...
          value: function pausar(a) {
            ...
            var ap;
            ap = document.getElementById('audioPlayer');
            if (ap) ap.pause(); // clearTimeout( this.audioTiempo );
            // this.audio.pause();
